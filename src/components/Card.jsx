...
export default function Card() {
    return (
        <div>
            <div className="card w-60 h-[360px] shadow-xl shadow-myblack  px-7 py-6 border-[1px] border-mylight-gray
            hover:transform hover:bg-myblack ">
                ...
                <div className="card-body items-center text-center lato px-0 pb-0">
                    ...
                    <div className="card-title w-full flex justify-between">
                        <div className='tienne text-base text-mywhite-two'>Hello</div>
                        {/* limit */}
                    ...
                    <p className='lato font-normal tracking-4 text-sm w-full px-0 mx-0 pt-4 pb-0 text-mylight-gray' 
